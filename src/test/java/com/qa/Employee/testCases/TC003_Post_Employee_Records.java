...
public class TC003_Post_Employee_Records extends TestBase {
	...
	@BeforeClass
	void Create_New_User() throws InterruptedException {
	...
	void checkResposeBody()
	{
		...
		Assert.assertEquals(responseBody.contains(EmpsubjectId), true);
	...
	@AfterClass
	void tearDown() {
		logger.info("*********  Finished TC003_Get_All_Employees **********");
	}
}
